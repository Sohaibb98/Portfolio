...
public class TypeChecker extends Visitor {
	...
	System.out.println("Number of candidate method: "+candidateMethods.nchildren);
	...
	if (is.thenpart()!=null)
		...
		Error.error(is,"If statement had no then part statement.");
	if (is.elsepart()!=null)
...
//	Type nType = in.targetMethod.getMyClass().
	...
	{	
		...
		//System.out.println((ClassDecl)ne.myDecl+": "+this.currentSequence.nchildren);
